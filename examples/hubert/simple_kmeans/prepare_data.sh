...
#./prepare_data.sh 16 12 "/nobackup/users/kzqian/data/hubert/librispeech/feat_v01_1_12" "/nobackup/users/kzqian/data/hubert/librispeech/label_v01_1_100_12" "/nobackup/users/kzqian/data/hubert/librispeech/km_v01/km100_12_1" "/nobackup/users/kzqian/ssl-disentangle/v01_1/checkpoints/checkpoint_random.pt"
...
CUDA_VISIBLE_DEVICES=$(bc <<< "${rank}/${ntasks}") python dump_hubert_feature_spk.py "/nobackup/users/kzqian/data/hubert/librispeech/meta" "train" $ckpt_path $layer ${nshard} ${rank} $feat_dir &
pids+=($!)
done
python dump_hubert_feature_spk.py "/nobackup/users/kzqian/data/hubert/librispeech/meta" "valid" $ckpt_path $layer 1 0 $feat_dir &
pids+=($!)
