...
logger = logging.getLogger("dump_hubert_feature_perm")


class HubertFeatureReader(object):
    def __init__(self, split, ckpt_path, layer, max_chunk=1600000):
        (
            model,
            cfg,
            task,
        ...
        with open("/nobackup/users/kzqian/data/hubert/librispeech/spk2info.dict", "rb") as f:
...
def main(tsv_dir, split, ckpt_path, layer, nshard, rank, feat_dir, max_chunk, disable_tqdm):
    reader = HubertFeatureReader(split, ckpt_path, layer, max_chunk)
