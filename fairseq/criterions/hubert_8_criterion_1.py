...
@dataclass
class HubertCriterionConfig_8_1(FairseqDataclass):
    ...
    q: float = field(
        default=0.5,
        metadata={"help": "hyperparam of RINCE"},
    )
    lam: float = field(
        default=0.001,
        metadata={"help": "hyperparam of RINCE"},
...
@register_criterion("hubert_8_1", dataclass=HubertCriterionConfig_8_1)
class HubertCriterion_8_1(FairseqCriterion):
    def __init__(self, task, q, lam, pred_masked_weight, pred_nomask_weight, loss_weights=None, log_keys=None):
        super().__init__(task)
