...
class HubertDataset_2(FairseqDataset):
    ...
    def collater(self, samples):
        ...
        collated_audios_1, padding_mask, audio_starts = self.collater_audio(
            audios_1, audio_size
        )
        collated_audios_2, padding_mask_2, audio_starts_2 = self.collater_audio(
            audios_2, audio_size
        )
        assert torch.equal(padding_mask, padding_mask_2)
        assert audio_starts == audio_starts_2
        ...
        net_input = {"source_1": collated_audios_1, "source_2": collated_audios_2, 
                     "padding_mask": padding_mask, "spk_emb": collated_embs}
        batch = {
