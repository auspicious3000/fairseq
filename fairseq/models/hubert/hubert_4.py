...
@dataclass
class HubertConfig_4(FairseqDataclass):
...
@register_model("hubert_4", dataclass=HubertConfig_4)
class HubertModel_4(BaseFairseqModel):
    def __init__(
        self,
        cfg: HubertConfig_4,
        ...
        super().__init__()
        logger.info(f"HubertModel Config 4: {cfg}")
    ...
    @classmethod
    def build_model(cls, cfg: HubertConfig_4, task: HubertPretrainingTask):
        """Build a new model instance."""

        model = HubertModel_4(cfg, task.cfg, task.dictionaries)
        return model
