...
@dataclass
class HubertAsrConfig_1(FairseqDataclass):
    w2v_path: str = field(
    ...
    only_feature_extractor: bool = field(
        default=False,
        metadata={"help": "if true, only load feature extractor"},
    )
...
@dataclass
class HubertCtcConfig(HubertAsrConfig_1):
    pass


@register_model("hubert_ctc_1", dataclass=HubertCtcConfig)
class HubertCtc_1(BaseFairseqModel):
...
@dataclass
class HubertSeq2SeqConfig(HubertAsrConfig_1):
...
class HubertEncoder(FairseqEncoder):
    def __init__(self, cfg: HubertAsrConfig_1, tgt_dict=None):
