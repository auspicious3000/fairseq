...
@dataclass
class HubertPretrainingConfig_1(FairseqDataclass):
    data: str = field(
    ...
    random_perm: Optional[bool] = field(
        default=True,
        metadata={"help": "random formant and f0 and eq permutation"},
    )
...
@register_task("hubert_1_pretraining", dataclass=HubertPretrainingConfig_1)
class HubertPretrainingTask_1(FairseqTask):

    cfg: HubertPretrainingConfig_1
    ...
    def __init__(
        ...
        logger.info(f"HubertPretrainingTask_1 Config {cfg}")
    ...
    @classmethod
    def setup_task(
        cls, cfg: HubertPretrainingConfig_1, **kwargs
    ) -> "HubertPretrainingTask_1":
        return cls(cfg)
    ...
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        self.datasets[split] = HubertDataset_1(
            ...
            random_perm=self.cfg.random_perm,
            crop=self.cfg.crop,
