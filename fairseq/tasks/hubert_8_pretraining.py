...
from fairseq.data import Dictionary, HubertDataset_5
...
@dataclass
class HubertPretrainingConfig_8(FairseqDataclass):
    data: str = field(
    ...
    spk2info: Optional[str] = field(
        default=None,
        metadata={"help": "path to spk2info"},
    )
    km_model: Optional[str] = field(
        default=None,
...
@register_task("hubert_8_pretraining", dataclass=HubertPretrainingConfig_8)
class HubertPretrainingTask_8(FairseqTask):

    cfg: HubertPretrainingConfig_8
    ...
    def __init__(
        ...
        logger.info(f"HubertPretrainingTask_8 Config {cfg}")
    ...
    @classmethod
    def setup_task(
        cls, cfg: HubertPretrainingConfig_8, **kwargs
    ...
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        self.datasets[split] = HubertDataset_5(
            manifest,
